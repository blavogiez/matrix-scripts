...
phase2_install() {
    ...
    # Layout: P0: dns | P1: backup | P2: db | P3: element | P4: matrix | P5: rproxy | P6: dashboard
...
# Lancement du setup parallèle (P0: dns | P1: backup | P2: db | P3: element | P4: matrix | P5: rproxy | P6: dashboard)
